...
PYBIND11_MODULE(firesim, m) {
    ...
    py::class_<DroneState, State, std::shared_ptr<DroneState>>(m, "DroneState")
            .def(py::init<double, double, std::pair<double, double>, std::vector<std::vector<int>>, std::vector<std::vector<int>>, std::vector<std::vector<int>>, std::pair<int, int>, std::pair<int, int> >())
